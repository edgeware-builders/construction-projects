...
Please provide the following:
  ...
  * An indication of how you will integrate this project into Edgeware.
...
Below we provide an **example roadmap**. In the descriptions it should be clear how the project is related to Edgeware. We recommend that the scope of the work can fit within a 3 month period and that teams structure their roadmap as 1 month = 1 milestone. 
